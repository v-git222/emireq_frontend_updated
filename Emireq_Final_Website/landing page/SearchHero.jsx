...
export default function SearchHero({ initialItems }) {
  ...
  useEffect(() => {
    ...
    setFiltered(
      q
        ? base.filter((it) => it.title.toLowerCase().includes(q))
        : base
    );
  }, [query, initialItems]);
    ...
    <section className="hero" ref={containerRef}>
      <div className="hero__controls">
        ...
        <div className="hero__buttons">
          {/* Always-blue Get Started button */}
  ...
  <form className="searchbar" onSubmit={(e) => e.preventDefault()}>
    <div className="searchbar__left" style={{ position: "relative" }}>
      ...
      {/* ✅ MOVE SUGGESTIONS HERE */}
      {open && (
        <div
          className="search-suggestions"
          id="trending-suggestions"
          role="dialog"
          aria-label="Search suggestions"
        >
          <TrendingCard items={filtered} onSelect={selectItem} />
        </div>
      )}
    </div>
